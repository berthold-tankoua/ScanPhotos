    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="alertModalLabel">Effectuer une réservation</h1>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div
                                            ...
                                            <p class="small text-muted mt-2 mb-0"><strong>Événements illimités</strong>.
                                                Pour les
                                                photographes et pros.</p>
                                        </div>
                                    </div>
                                </div>
